...
const SYSTEM = [
  "You are an experienced ESL test writer. Generate a CEFR-aligned practice test.",
  ...
  "- Reading passage 120-220 words, on the requested topic, level-appropriate.",
  ...
  '- Each MCQ "explanation" is one short sentence justifying the answer.',
  "- Writing prompt must reference the topic and suit the level. Word range scales with level (A1=40-60, A2=60-80, B1=80-120, B2=120-180, C1=180-250, C2=220-300).",
  "- Vocabulary and grammar should reflect the target CEFR level's typical demands.",
  "- Use natural English, not stilted textbook phrasing.",
].join(" ");
