...
export async function POST(req: Request) {
  ...
  const system =
    "Bạn là giáo viên tiếng Anh, tạo bài tập ngữ pháp cho học viên người Việt. " +
    ...
    "Câu hỏi (prompt/options) viết bằng TIẾNG ANH. 'explain' viết bằng TIẾNG VIỆT, ngắn gọn. " +
    "Không lặp lại câu, độ khó phù hợp trình độ đã cho.";

  const prompt =
    `Chủ đề ngữ pháp: "${title}" (trình độ ${level}). ` +
